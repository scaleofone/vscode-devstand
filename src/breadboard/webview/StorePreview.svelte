...
<div style="position: absolute; top: 0; right: 0; padding: 1rem;">
    <details class="inline-block">
        <summary class="cursor-pointer hover:fg-link select-none">records</summary>
        <pre style="background-color: white;">{JSON.stringify($records, null, 2)}</pre>
    </details>
    <br>
    <details class="inline-block">
    ...
    <br>
    <details class="inline-block">
        <summary class="cursor-pointer hover:fg-link select-none">brickCoordinates</summary>
        <pre style="background-color: white;">{JSON.stringify($brickCoordinates, null, 2)}</pre>
    </details>
    <br>
    <details class="inline-block">
